...
?>
      ...
      ?>
            <div class="box">
                ...
                <p> Status do Pagamento: <span
                        style="color:<?php if($fetch_orders['payment_status'] == 'Pendente'){ echo 'red'; }else{ echo 'green'; }; ?>"><?= $fetch_orders['payment_status']; ?></span>
                </p>
            </div>
            <?php
         }
    ...
    <section class="about" id="about">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <p>Na Pizzaria Delícia, cada pizza é mais que uma simples receita, é uma expressão de amor e dedicação.
                    Desde a escolha dos ingredientes frescos até a última fatia que chega à sua mesa, nosso compromisso
                    é garantir que cada mordida seja repleta de sabor e carinho. </p>
            ...
            <div class="box">
                ...
                <h3>Entrega de 30 minutos</h3>
                <p>Nossa promessa é rápida: em apenas 30 minutos, sua pizza estará quentinha e pronta para ser
                    saboreada. Com uma logística eficiente e uma equipe comprometida, garantimos que você possa
                    desfrutar da autenticidade da Pizzaria Delícia no conforto do seu lar, sem demoras.</p>
                <br><br><br><br><br>
                <a href="#menu" class="btn">Nosso Menu</a>
            </div>
            ...
            <div class="box">
                ...
                <h3>Compartilhar com quem ama</h3>
                <p>Acreditamos que uma boa pizza não é apenas uma refeição, mas sim um momento para ser compartilhado
                    com aqueles que mais amamos. Na Pizzaria Delícia, valorizamos esses momentos de convívio,
                    proporcionando não apenas uma experiência gastronômica, mas também a oportunidade de fortalecer
                    laços e criar memórias inesquecíveis ao redor da mesa.</p>
                <a href="#menu" class="btn">Nosso Menu</a>
            </div>
        ...
        <div class="accordion-container">
            ...
            <div class="accordion active">
                ...
                <p class="accrodion-content">
                    ...
                    nosso menu diversificado, faz seu pedido online ou por telefone e aguarda nossa entrega rápida e
                    eficiente. Em pouco tempo, você estará desfrutando de uma pizza fresca e saborosa no conforto da sua
                    casa.
                </p>
            </div>
            ...
            <div class="accordion">
                ...
                <p class="accrodion-content">
                    Nosso compromisso é entregar sua pizza em até 30 minutos após a confirmação do pedido. Nossa equipe
                    trabalha diligentemente para garantir que sua refeição chegue quentinha e deliciosa, sem demoras
                    desnecessárias.
                </p>
            </div>
            ...
            <div class="accordion">
                ...
                <p class="accrodion-content">
                    Absolutamente! Seja uma reunião casual entre amigos ou uma grande festa, estamos aqui para atender
                    às suas necessidades. Oferecemos opções de catering personalizado para tornar seu evento ainda mais
                    especial. Entre em contato conosco para discutir suas preferências e garantir que sua festa seja um
            ...
            <div class="accordion">
                ...
                <p class="accrodion-content">
                    Nossas pizzas são uma excelente fonte de proteína, especialmente se você optar por sabores que
                    contenham ingredientes ricos em proteína, como queijo, carne e frango. Cada pizza varia em sua
                    composição nutricional, mas fique tranquilo, pois garantimos que todas sejam preparadas com
            ...
            <div class="accordion">
                ...
                <p class="accrodion-content">
                    Na Pizzaria Delícia, priorizamos a qualidade e o sabor em cada pizza que preparamos. Nossas pizzas
                    são assadas em fornos especiais, sem a necessidade de óleo adicional. Utilizamos métodos de
    ...
    <section class="footer">
        ...
        <div class="credit">
            &copy; copyright @ <?= date('Y'); ?> por <span>João e Lucas</span> | Todos os direitos reservados!
        </div>
